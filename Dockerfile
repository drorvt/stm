...
RUN /opt/st/stm32cubeide_1.4.0/stm32cubeide --launcher.suppressErrors -nosplash -application org.eclipse.cdt.managedbuilder.core.headlessbuild -data /root/workspace -import /root/st-firmware-v2/
RUN /opt/st/stm32cubeide_1.4.0/headless-build.sh -build VLAD_Tester/Debug -data /root/workspace/
